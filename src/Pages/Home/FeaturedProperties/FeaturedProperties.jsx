  ...
  return (
    <Container>
      <div className="pt-[40px]">
        ...
        <p className="text-[#5D534A] font-normal md:text-[28px] md:leading-[33.89px] tracking-[.5%] pt-3 md:pt-[38px]  md:pb-[92px] text-center">
          The well-furnished home and apartments are available
        </p>
        <div className="md:pb-[74px] md:flex gap-[41px]">
          <div className="md:w-[447.96px] md:h-[602px] max-sm:pt-[20px]">
            <img
              className="md:w-[447.96px] h-[350px] md:h-[532.6px]"
              src={property1}
              alt=""
            />
            <h1 className="text-[#878987] font-bold text-[25px] md:text-[36px] md:leading-[46.87px] tracking-[.3%] pt-3 md:pt-6 text-center">
              Cozy Living Room
            </h1>
          </div>
          <div className="md:w-[447.96px] md:h-[602px] max-sm:pt-[20px]">
