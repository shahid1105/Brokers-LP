...
const QuaryPath = () => {
  return (
    <Container>
      ...
      <h1 className="font-semibold text-[30px] md:text-[50px] leading-[120%] text-center pt-[60px] pb-[20px] md:pb-0 md:pt-[28px]">
        Everything should be this easy.
      </h1>
      <div className="flex flex-col md:flex-row text-center items-center gap-[60px] md:gap-[160px] pt-[28px] pb-[81px]">
        <div>
          <img className="mx-auto w-[75px] h-[75px]" src={messages} alt="" />
          <h3 className="font-semibold text-[23px] md:text-[28px] leading-[120%] my-4 md:my-[22px]">
            Answer questions
          </h3>
